...
import { useNavigate, BrowserRouter, Link, Route, Routes, Outlet } from 'react-router-dom';
...
todayCheck = yyyy + mm + dd;
  ...
  const renderMenu = (
    ...
    >
      <MenuItem onClick={handleMenuClose}  component={Link} to = " Dashboard/myaccount" >My account</MenuItem>
  ...
  return (
        ...
        <Toolbar>
          ...
          <Search  sx={{ display: { xs: 'none', md: 'flex' } }} >
            ...
            type='text'
              ...
              id = "findInput"
            />
             <IconButton color='inherit' onClick={FindNext} sx={{position: 'relative'}}>
            <SearchIcon />
          </IconButton> 
    ...
    <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <ListItem button component={Link} to = "/sqlrun" selected={location.pathname == "/sqlrun"? true : false}>
            <ListItemIcon>
            ...
            <ListItem button component={Link} to = "/report" selected={location.pathname == "/report"? true : false}>
            <ListItemIcon>
              <AutoAwesomeIcon color = "primary" />
            </ListItemIcon>
            ...
            <ListItem button component={Link} to = "/chart" selected={location.pathname == "/chart"? true : false}>
            <ListItemIcon>
              <AutoAwesomeIcon color = "primary" />
            </ListItemIcon>
            <ListItemText primary="Report" />
      ...
      <Box component="main" sx={{ flexGrow: 1, pr : 5, pl : 5 , pb : 5,  width : '95%'}}>
        <DrawerHeader />
